...
public class Main {
    public static void main(String[] args) {
        ...
        Student st4 = new Student("Чехоа А.П", 5, grades1);
        Student st5 = new Student("Иванов А.А", 16, grades);
        Student st6 = new Student("Иванов А.А", 10, grades2);
        Student st7 = new Student("Иванов А.А", 2, grades);
        Student st8 = new Student("Иванов А.А", 10, grades);
        ...
        logicStudent.findStudentWithGoodGrades(group);
